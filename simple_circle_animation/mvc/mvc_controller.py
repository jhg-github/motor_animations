...
class CircleController:
    def __init__(self, model):
        ...
        # Radius slider
        self.radius_slider = arcade.gui.UISlider(value=self.model.radius, min_value=20, max_value=500, width=300)
        ...
        # Speed slider
        self.speed_slider = arcade.gui.UISlider(value=self.model.speed, min_value=0.1, max_value=5.0, width=300)
        ...
        self.anchor.add(child=self.v_box, anchor_x="left", anchor_y="bottom")
